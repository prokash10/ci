                   ...
                   ?>
                      ...
                      <form role="form" method="post" action="<?php echo base_url('user/register_user'); ?>">
                          <fieldset>
                              ...
                              <div class="form-group">
                                  <input class="form-control" placeholder="Enter Age" name="age" type="number" value="">
                              </div>

                              <div class="form-group">
                                  <input class="form-control" placeholder="Enter 10 diMobile No" name="phone" type="number" value="">
                              </div>
